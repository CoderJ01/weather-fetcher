...
// utils
import { popularCites, processSearch } from './Dashboard.util';
...
const Dashboard = () => {
    ...
    // const forecastData = getData(`https://api.openweathermap.org/data/2.5/onecall?lat=${weatherData.data.coord.lat}&&units=imperial&lon=${weather.data.coord.lon}&exclude=hourly&appid=${process.env.REACT_APP_OPEN_WEATHER_API_KEY}`);

    const handleSearchSubmit = () => {
        const weatherData = GetData(`https://api.openweathermap.org/data/2.5/weather?q=${input}&appid=${process.env.REACT_APP_OPEN_WEATHER_API_KEY}`);
